...
void New_MapSelect_Init(GameState* thisx) {
    ...
    this->state.main = New_MapSelect_Main;
    this->state.destroy = New_MapSelect_Destroy;
    this->scenes = sScenes;
...
void New_MapSelect_Main(GameState* thisx) {
    ...
    New_MapSelect_UpdateMenu(this);
    New_MapSelect_Draw(this);
}
...
void New_MapSelect_Draw(MapSelectState* this) {
    ...
    if (!this->state.running) {
        New_MapSelect_DrawLoadingScreen(this);
    } else {
        New_MapSelect_DrawMenu(this);
    }
...
void New_MapSelect_DrawMenu(MapSelectState* this) {
    ...
    if (!this->showControls) {
        New_MapSelect_PrintMenu(this, printer);
        New_MapSelect_PrintAgeSetting(this, printer, ((void)0, gSaveContext.linkAge));
        New_MapSelect_PrintSceneLayerSetting(this, printer);
    }
    New_MapSelect_PrintControls(this, printer);
...
void New_MapSelect_DrawLoadingScreen(MapSelectState* this) {
    ...
    GfxPrint_Init(printer);
    GfxPrint_Open(printer, POLY_OPA_DISP);
    New_MapSelect_PrintLoadingMessage(this, printer, 15);
    POLY_OPA_DISP = GfxPrint_Close(printer);
    GfxPrint_Destroy(printer);
