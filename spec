...
beginseg
    ...
    include "build/src/rdb/ed64_x.o"
    include "build/src/rdb/hb_io.o"
    include "build/src/rdb/io.o"
    include "build/src/rdb/pi.o"
    include "build/src/rdb/rdb.o"
    include "build/src/rdb/vr4300.o"
