...
# If DEBUG_BUILD is 1, compile with DEBUG_ROM defined and GCC
DEBUG_BUILD ?= 1
...
ifeq ($(COMPILER),ido)
  ...
  CC_CHECK  = gcc -fno-builtin -fsyntax-only -funsigned-char -std=gnu90 -D_LANGUAGE_C $(MIPS_BUILTIN_DEFS) $(INC) $(CHECK_WARNINGS)
